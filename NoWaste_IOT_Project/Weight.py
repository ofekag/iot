...
global clientname, CONNECTED, Weight_CURR
CONNECTED = False
r=random.randrange(1,10000000)
clientname="IOT_client-Id234-"+str(r)
DHT_topic = 'pr/Waste/5976397/sts'
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Garbage Indicator')        
    ...
    def update_data(self):
        global Weight_CURR
        print('Next update')
        Weight_CURR=Weight_CURR+random.randrange(1,10)
        IR_STATE = self.connectionDock.IR.isChecked()
        Weight_data='Weight: '+str(Weight_CURR)
        IR_data = ' IR_STATE: '+ str(IR_STATE)
        total_data = Weight_data + IR_data
        self.connectionDock.Weight.setText(str(Weight_CURR))
        self.mc.publish_to(DHT_topic,total_data)
